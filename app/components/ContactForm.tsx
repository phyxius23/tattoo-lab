...
export default function ContactForm() {
	...
	return (
		<form onSubmit={handleSubmit}>
			...
			>
				Dichiaro di aver letto la privacy policy nonché di avere già compiuto quattordici anni
				e, se minore di quattordici, di essere stato autorizzato dal titolare della
				responsabilità genitoriale, pertanto presto il mio consenso per ricevere le
				informazioni.
			</label>
